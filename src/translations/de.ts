...
export const germanTranslations = {
  ...
  certificationRecognition: 'FSP & Anerkennungs-Unterstützung',
  examPreparation: 'Umfassende Vorbereitung auf die Fachsprachenprüfung (FSP) und den beruflichen Anerkennungsprozess im deutschen Gesundheitswesen.',
