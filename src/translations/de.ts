...
export const germanTranslations = {
  ...
  medicalGerman: 'Medizinisches Deutsch für fortgeschrittene Lerner',
  improveYour: 'Verbessere deine',
  medicalCommunication: 'medizinische Kommunikation',
  trainScenarios: 'Übe Dialogszenarien und Fachvokabular für deinen beruflichen Alltag im Gesundheitswesen, ab B1-Niveau.',
  targetAudience: 'Perfekt für Ärzte, Pflegekräfte, Betreuer und Studierende in medizinischen Bereichen, die in deutschen Gesundheitseinrichtungen erfolgreich sein und berufliche Anerkennung erreichen möchten.',
  // Registration page
  ...
  practiceConversations: 'Übe mit realistischen Gesprächssituationen aus dem Gesundheitswesen - von der Patientenversorgung bis zur Teamkommunikation in Krankenhäusern, Praxen und der häuslichen Pflege.',
  allLanguageLevels: 'Für Fortgeschrittene Lerner',
  customContent: 'Maßgeschneiderte Inhalte für die Sprachniveaus B1 bis C1 - baue auf deinen bestehenden Deutschkenntnissen mit medizinischer Spezialisierung auf.',
  ...
  anerkennungFspSupport: 'Anerkennung & FSP-Unterstützung',
  anerkennungExamPreparation: 'Umfassende Vorbereitung auf die berufliche Anerkennung und die Fachsprachenprüfung (FSP) im deutschen Gesundheitswesen.',
  flexibleLearning: 'Flexibles Lernen',
  flexibleLearningDesc: 'Lerne in deinem eigenen Tempo mit sofortiger praktischer Anwendung in deiner täglichen medizinischen Arbeitsumgebung.',
  ...
  ctaText: 'Starte jetzt mit den Übungen und verbessere deine berufliche Kommunikation im medizinischen Bereich - für fortgeschrittene Lerner (B1-C1).',
  ...
  realisticHospitalScenarios: "Realistische Gesundheitsszenarien",
  realisticHospitalScenariosDesc: "Üben Sie mit authentischen Dialogszenarien aus Krankenhäusern, Praxen, häuslicher Pflege und anderen Gesundheitsumgebungen.",
