...
export const englishTranslations = {
  ...
  certificationRecognition: 'FSP Preparation',
  examPreparation: 'Optimal preparation for the Fachsprachenprüfung (FSP) and other language exams for professional recognition in German healthcare.',
