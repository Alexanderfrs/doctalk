export const englishTranslations = {
  ...
  anerkennungExamPreparationLong: 'Navigate the German medical system with confidence. We offer comprehensive preparation for professional recognition (Anerkennung) and the specialized language exam (FSP), paving your way to a successful career in Germany. (Coming Soon)',
