export const turkishTranslations = {
  ...
  specializedForMedical: 'DocTalk\'ı Neden Seçmelisiniz?',
  doctalkDifference: 'DocTalk\'ın genel uygulamalar, özel öğretmenler ve dil okullarının basitçe eşleşemeyeceği odaklanmış, esnek eğitimi nasıl sağladığını keşfedin.',
  ...
  // Pre-launch pricing
  alphaTester: "Alfa Test Kullanıcısı",
  alphaTesterDesc: "Tıbbi öğrenimin geleceğini şekillendirmeye hazır öncüler için.",
  alphaFeature1: "Alfa aşamasında tam erişim",
  alphaFeature2: "Özellik geliştirme üzerinde doğrudan etki",
  alphaFeature3: "Profilinizde özel 'Kurucu' rozeti",
  joinAlphaWaitlist: "Alfa bekleme listesine katıl",
  claimAlphaSpot: "Alfa yerini talep et",

  earlyBirdProfessional: "Erken Kuş Profesyonel",
  earlyBirdProfessionalDesc: "Lansmandan önce ömür boyu indirim güvence altına alın.",
  launchSpecial: "Lansman Özel Teklifi",
  reserveEarlyBirdSpot: "Erken Kuş yerini rezerve et",

  enterpriseSolutions: "Kurumsal Çözümler",
  enterpriseSolutionsDesc: "Klinikler, hastaneler ve eğitim kurumları için.",
  enterpriseFeature1: "Özelleştirilmiş onboarding ve destek",
  enterpriseFeature2: "Ekip ilerleme takibi ve analitiği",
  enterpriseFeature3: "Toplu lisanslama ve esnek faturalandırma",
  ...
  alphaAccessLimitedPre: "Alfa erişimi",
  alphaAccessLimitedBold: "50 kişi ile sınırlı.",
  alphaAccessLimitedPost: "",
  alphaAccessCta: "Yerinizi ayırtın!",
