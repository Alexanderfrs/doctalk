...
export const turkishTranslations = {
  ...
  anerkennungExamPreparationLong: 'Alman tıp sisteminde güvenle ilerleyin. Mesleki tanınırlık (Anerkennung) ve Fachsprachenprüfung (FSP) için kapsamlı hazırlık sunarak Almanya\'da başarılı bir kariyere giden yolunuzu açıyoruz. (Yakında gelecek)',
