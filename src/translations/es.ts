export const spanishTranslations = {
  ...
  safeFlexibleTrainingDesc: 'Practica de forma segura, recibe feedback instantáneo (incluso de pronunciación) y sigue tu progreso en tu ruta de aprendizaje personalizada.',
