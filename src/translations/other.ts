export const romanianTranslations = {
  ...
  examPreparation: 'Pregătire optimă pentru examenele de limbă pentru recunoașterea profesională în sistemul medical german.',
...
export const polishTranslations = {
  ...
  examPreparation: 'Optymalne przygotowanie do egzaminów językowych w celu uzyskania uznania zawodowego w niemieckiej służbie zdrowia.',
